<?php
class Migration_tipo_evento_table extends Migration
{
    /*
...
// Assign them to the admin role
        ...
        $this->role_permission_model->assign_to_role('Administrator', 'Bonfire.tbl_tipo_evento.View');
    }
...
//--------------------------------------------------------------------
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table('tbl_tipo_evento');
    }
