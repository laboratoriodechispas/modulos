<?php
class Migration_respuestas_usuarios_table extends Migration
{
    /*
    ...
    public function up()
    {
        ...
        $this->dbforge->add_field('id_relacion BIGINT(20) NOT NULL');
        ...
        $this->dbforge->create_table('tbl_respuestas_usuarios');

// Create the Permissions
        $this->load->model('permission_model');
        $this->permission_model->insert(array(
            'name'          => 'Bonfire.tbl_respuestas_usuarios.View',
...
// Assign them to the admin role
        ...
        $this->role_permission_model->assign_to_role('Administrator', 'Bonfire.tbl_respuestas_usuarios.View');
    }
...
//--------------------------------------------------------------------
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table('tbl_respuestas_usuarios');
    }
