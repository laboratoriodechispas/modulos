<?php
class Migration_organizadores_table extends Migration
{
    /*
    ...
    public function up()
    {
        ...
        $this->dbforge->add_field('id_estado INT(11) NOT NULL');
...
// Assign them to the admin role
        ...
        $this->role_permission_model->assign_to_role('Administrator', 'Bonfire.tbl_organizadores.View');
    }
...
//--------------------------------------------------------------------
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table('tbl_organizadores');
    }
