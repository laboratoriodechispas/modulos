<?php
class Migration_marcas_ropa_table extends Migration
{
    /*
    ...
    public function up()
    {
        ...
        $this->dbforge->create_table('tbl_marcas_ropa');

// Create the Permissions
        $this->load->model('permission_model');
        $this->permission_model->insert(array(
            'name'          => 'Bonfire.tbl_marcas_ropa.View',
...
// Assign them to the admin role
        ...
        $this->role_permission_model->assign_to_role('Administrator', 'Bonfire.tbl_marcas_ropa.View');
    }
...
//--------------------------------------------------------------------
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table('tbl_marcas_ropa');
    }
